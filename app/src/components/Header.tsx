...
export const Header: React.FC = () => {
  return (
    <header className="w-full bg-gradient-to-br from-gray-700 via-gray-600 to-gray-500 flex items-center justify-center overflow-hidden py-4">
      <div className="w-full max-w-[92rem] mx-auto flex justify-between items-center px-5">
        ...
        {/* GitHub Icon */}
        <a 
          href="https://github.com/SnoozingJellyfish/OpenFisca-Zero" 
          target="_blank" 
